...
class Monitor:
    ...
    def process_notifications(self, snapshot):
        ...
        try:
            self.notification_manager.process(snapshot.get("alerts") or [], server_statuses=statuses)
        except Exception:
            self.notification_manager.record_runtime_error()
